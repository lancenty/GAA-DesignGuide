...
const warningCardHeader = {
  background: "linear-gradient(60deg, #ffa726, #EB9508)",
  ...warningBoxShadow
};
const successCardHeader = {
  background: "linear-gradient(60deg, #43A546, #2F9132)",
  ...successBoxShadow
};
const dangerCardHeader = {
  background: "linear-gradient(60deg, #ab0520, #97000C)",
  ...dangerBoxShadow
};
const infoCardHeader = {
  background: "linear-gradient(60deg, #00D7F3, #00CDDF)",
  ...infoBoxShadow
};
const primaryCardHeader = {
  background: "linear-gradient(60deg, #157bdc, #0167C8)",
  ...primaryBoxShadow
};
